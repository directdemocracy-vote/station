...
if ($error !== '')
  error("failed to verify app signature: $error \"".base64_encode($voteBytes)."\"");
...
$query = "INSERT INTO vote(appKey, appSignature, referendum, number, ballot, answer) VALUES("
        ...
        ."\"$vote->answer\") "
        ."ON DUPLICATE UPDATE appSignature=FROM_BASE64('$vote->appSignature'), number=$vote->number, answer=\"$vote->answer\";";
